...
// toggleTheme: функция без аргументов, которая будет изменять тему с "light" на "dark" или наоборот.
...
//  что означает, что пока мы не предоставим данные
//  в контексте (при помощи Provider), контекст будет пустым.
